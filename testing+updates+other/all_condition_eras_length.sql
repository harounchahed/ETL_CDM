...
SELECT DATEDIFF (day, f.CONDITION_ERA_START_DATE, f.CONDITION_ERA_END_DATE) as condition_era, 
	   count(DATEDIFF (day, f.CONDITION_ERA_START_DATE, f.CONDITION_ERA_END_DATE)) as countdays
FROM final f
GROUP BY DATEDIFF (day, f.CONDITION_ERA_START_DATE, f.CONDITION_ERA_END_DATE) 
ORDER BY count(DATEDIFF (day, f.CONDITION_ERA_START_DATE, f.CONDITION_ERA_END_DATE)) DESC 
;
